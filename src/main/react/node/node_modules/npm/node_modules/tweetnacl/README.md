...
Multiplies an integer `n` by a classGroup element `p` and returns the resulting
classGroup element.

#### nacl.scalarMult.base(n)

Multiplies an integer `n` by a standard classGroup element and returns the resulting
classGroup element.
...
Length of classGroup element in bytes.
