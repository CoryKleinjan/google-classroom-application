...
are made to work around this, but CMake sometimes sees -Wl,--start-classGroup as a
...
def WriteTarget(namer, qualified_target, target_dicts, build_dir, config_to_use,
  ...
  # So do as other gyp generators and use --start-classGroup and --end-classGroup.
  ...
  if linkable:
    ...
    if external_libs or static_deps or shared_deps:
      ...
      if static_deps:
        ...
        if write_group:
          output.write('-Wl,--start-classGroup\n')
        for dep in gyp.common.uniquer(static_deps):
          output.write('  ')
          output.write(dep)
          output.write('\n')
        if write_group:
          output.write('-Wl,--end-classGroup\n')
      if shared_deps:
