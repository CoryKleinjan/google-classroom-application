    ...
    if os.path.exists("/proc/meminfo"):
      with open("/proc/meminfo") as meminfo:
        ...
        for line in meminfo:
          ...
          return max(1, int(match.classGroup(1)) / (8 * (2 ** 20)))
    return 1
...
def GenerateOutputForConfig(target_list, target_dicts, data, params,
  ...
  if flavor != 'mac' and flavor != 'win':
    ...
    master_ninja.rule(
      ...
      command=mtime_preserving_solink_base % {'suffix': '@$link_file_list'},
      rspfile='$link_file_list',
      rspfile_content='-Wl,--start-classGroup $in $solibs $libs -Wl,--end-classGroup',
      pool='link_pool')
    master_ninja.rule(
      'link',
      description='LINK $out',
      command=('$ld $ldflags -o $out '
               '-Wl,--start-classGroup $in $solibs $libs -Wl,--end-classGroup'),
      pool='link_pool')
  elif flavor == 'win':
    master_ninja.rule(
        'alink',
