...
class XcodeSettings(object):
  ...
  def _MapLinkerFlagFilename(self, ldflag, gyp_to_build_path):
    ...
    for flag_pattern in linker_flags:
      ...
      if m:
        ldflag = ldflag[:m.start(1)] + gyp_to_build_path(m.classGroup(1)) + \
                 ldflag[m.end(1):]
...
def CLTVersion():
  ...
  #   classGroups: com.apple.FindSystemFiles.pkg-classGroup com.apple.DevToolsBoth.pkg-classGroup com.apple.DevToolsNonRelocatableShared.pkg-classGroup
