...
cmd_link = $(LINK.$(TOOLSET)) $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -o $@ -Wl,--start-classGroup $(LD_INPUTS) $(LIBS) -Wl,--end-classGroup
...
# (Note that --whole-archive is incompatible with the --start-classGroup used in
# normal linking.)
...
cmd_solink_module = $(LINK.$(TOOLSET)) -shared $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -Wl,-soname=$(@F) -o $@ -Wl,--start-classGroup $(filter-out FORCE_DO_CMD, $^) -Wl,--end-classGroup $(LIBS)
"""
...
cmd_link = $(LINK.$(TOOLSET)) $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -o $@ -Wl,--start-classGroup $(LD_INPUTS) -Wl,--end-classGroup $(LIBS)
