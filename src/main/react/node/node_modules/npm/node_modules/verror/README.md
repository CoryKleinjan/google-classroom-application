...
error messages (e.g., to localize them, format them, classGroup them by type, and so
...
MultiError is an Error class that represents a classGroup of Errors.  This is used
