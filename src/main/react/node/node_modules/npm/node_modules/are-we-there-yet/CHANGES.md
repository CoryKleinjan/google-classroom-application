...
* Add tracker classGroup cycle detection and tests for it
...
* Rewrote completion percent computation to be low impact– no more walking a
  tree of completion classGroups every time we need this info.  Previously, with
  medium sized tree of completion classGroups, even a relatively modest number of
